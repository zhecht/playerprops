...
def isBarrel(data):
	evo = int(data["evo"] or 0)
	la = int(data["la"] or 0)
	if evo < 98:
		return False

	thresh = {98: [26, 30], 99: [25, 31], 100: [24, 33], 101: [23, 34], 102: [22, 35], 103: [21, 36], 104: [20, 37], 105: [19, 38], 106: [18, 39], 107: [17, 40], 108: [16, 41], 109: [15, 42], 110: [14, 43], 111: [13, 44], 112: [12, 45], 113: [11, 46], 114: [10, 47], 115: [9, 48], 116: [8, 49]}
	if evo > 116:
